...
describe "IFrame", ->
  ...
  it "should load iframe document", ->
    ...
    assert.equal iframeDocument.URL, "http://example.com:3003/iframe/static"
  ...
  it "should not alter the parent", ->
    browser.assert.url "http://example.com:3003/iframe"
  ...
  describe "postMessage", ->
    ...
    it "should pass messages back and forth", ->
      browser.assert.text "title", "pong http://example.com:3003"
