...
vows.describe("Browser").addBatch(
    ...
    "visit":
      ...
      "empty page":
        topic: ->
          ...
          browser = new Browser
          browser.wants "http://localhost:3003/empty", @callback
      ...
      "successful":
        topic: ->
          brains.ready =>
            ...
            browser.window.location = "http://localhost:3003/scripted"
  ...
  "content selection":
    topic: ->
      brains.get "/walking", (req, res)-> res.send """
        <html>
          <head>
            <script src="/jquery.js"></script>
      ...
      brains.get "/app.js", (req, res)-> res.send """
        ...
        """
      browser = new Browser
      browser.wants "http://localhost:3003/walking", @callback
    "query text":
  ...
  "click link":
    topic: ->
      brains.get "/head", (req, res)-> res.send """
        <html>
          <body>
            <a href="/dead">Smash</a>
          </body>
      ...
      brains.get "/dead", (req, res)-> res.send """
        ...
        """
      browser = new Browser
      browser.wants "http://localhost:3003/head", =>
  ...
  "fork":
    topic: ->
      brains.get "/living", (req, res)-> res.send "<html><body></body></html>"
      brains.get "/dead", (req, res)-> res.send "<html><body></body></html>"
